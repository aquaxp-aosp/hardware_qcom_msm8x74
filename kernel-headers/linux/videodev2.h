...
#define V4L2_CID_MPEG_VIDC_VIDEO_ALLOC_MODE   (V4L2_CID_MPEG_MSM_VIDC_BASE+30)
enum v4l2_mpeg_vidc_video_alloc_mode_type {
 V4L2_MPEG_VIDC_VIDEO_STATIC = 0,
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
 V4L2_MPEG_VIDC_VIDEO_RING = 1,
};
#define V4L2_CID_MPEG_VIDC_VIDEO_FRAME_ASSEMBLY   (V4L2_CID_MPEG_MSM_VIDC_BASE+31)
enum v4l2_mpeg_vidc_video_assembly {
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
 V4L2_MPEG_VIDC_FRAME_ASSEMBLY_DISABLE = 0,
 V4L2_MPEG_VIDC_FRAME_ASSEMBLY_ENABLE = 1,
};
#define V4L2_CID_MPEG_VIDC_VIDEO_VP8_PROFILE_LEVEL   (V4L2_CID_MPEG_MSM_VIDC_BASE+32)
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
